...
// EpisodeListViewV2 is the refactored episode list using the table abstraction
type EpisodeListViewV2 struct {
	table            *Table
...
func NewEpisodeListViewV2() *EpisodeListViewV2 {
	v := &EpisodeListViewV2{
		table:        NewTable(),
		episodes:     []*models.Episode{},
...
func (v *EpisodeListViewV2) SetPodcast(podcast *models.Podcast) {
...
func (v *EpisodeListViewV2) SetDownloadManager(dm *download.Manager) {
	v.downloadManager = dm
}

func (v *EpisodeListViewV2) SetCurrentEpisode(episode *models.Episode) {
	v.currentEpisode = episode
	// Update table rows to reflect new current episode
	v.updateTableRows()
}

func (v *EpisodeListViewV2) SetPlayer(p *player.Player) {
	v.player = p
}

func (v *EpisodeListViewV2) UpdateEpisodeDuration(episodeID string, newDuration time.Duration) {
...
func (v *EpisodeListViewV2) UpdateCurrentEpisodePosition(s tcell.Screen) {
...
func (v *EpisodeListViewV2) GetSelected() *models.Episode {
...
func (v *EpisodeListViewV2) GetCurrentPodcast() *models.Podcast {
	return v.currentPodcast
}

func (v *EpisodeListViewV2) Draw(s tcell.Screen) {
	w, h := s.Size()
...
func (v *EpisodeListViewV2) HandleKey(ev *tcell.EventKey) bool {
	switch ev.Key() {
	case tcell.KeyRune:
...
func (v *EpisodeListViewV2) HandlePageDown() bool {
	if v.table.PageDown() {
		v.descScrollOffset = 0
		return true
	}
...
func (v *EpisodeListViewV2) HandlePageUp() bool {
	if v.table.PageUp() {
		v.descScrollOffset = 0
		return true
	}
...
func (v *EpisodeListViewV2) getActiveEpisodes() []*models.Episode {
	if v.searchState.query != "" {
...
func (v *EpisodeListViewV2) applyFilter() {
...
func (v *EpisodeListViewV2) updateTableRows() {
	episodes := v.getActiveEpisodes()
...
func (v *EpisodeListViewV2) GetSearchState() *SearchState {
	return v.searchState
}

func (v *EpisodeListViewV2) UpdateSearch() {
	v.applyFilter()
}
...
func (v *EpisodeListViewV2) drawDescriptionWindow(s tcell.Screen, startY, width, height int) {
...
func (v *EpisodeListViewV2) wrapStyledText(text string, width int, highlightPositions []int, styles []markdown.StyleRange) []styledLineWithHighlights {
	if width <= 0 {
...
func (v *EpisodeListViewV2) wrapParagraphWithStyles(paragraph string, width int, paragraphStartPos int, highlightMap map[int]bool, styles []markdown.StyleRange) []styledLineWithHighlights {
...
func (v *EpisodeListViewV2) drawStyledLine(s tcell.Screen, x, y, maxWidth int, line styledLineWithHighlights) {
	highlightMap := make(map[int]bool)
