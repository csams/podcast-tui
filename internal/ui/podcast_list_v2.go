...
// PodcastListViewV2 is the refactored podcast list using the table abstraction
type PodcastListViewV2 struct {
	table            *Table
...
func NewPodcastListViewV2() *PodcastListViewV2 {
	v := &PodcastListViewV2{
		table:        NewTable(),
		podcasts:     []*models.Podcast{},
...
func (v *PodcastListViewV2) SetSubscriptions(subs *models.Subscriptions) {
	v.podcasts = subs.Podcasts
	v.applyFilter()
}

func (v *PodcastListViewV2) GetSelected() *models.Podcast {
...
func (v *PodcastListViewV2) Draw(s tcell.Screen) {
	w, h := s.Size()
...
func (v *PodcastListViewV2) HandleKey(ev *tcell.EventKey) bool {
	switch ev.Key() {
	case tcell.KeyRune:
...
func (v *PodcastListViewV2) HandlePageDown() bool {
	if v.table.PageDown() {
		v.descScrollOffset = 0
		return true
	}
...
func (v *PodcastListViewV2) HandlePageUp() bool {
	if v.table.PageUp() {
		v.descScrollOffset = 0
		return true
	}
...
func (v *PodcastListViewV2) getActivePodcasts() []*models.Podcast {
	if v.searchState.query != "" {
...
func (v *PodcastListViewV2) applyFilter() {
...
func (v *PodcastListViewV2) updateTableRows() {
	podcasts := v.getActivePodcasts()
...
func (v *PodcastListViewV2) GetSearchState() *SearchState {
	return v.searchState
}

func (v *PodcastListViewV2) UpdateSearch() {
	v.applyFilter()
}

// drawDescriptionWindow renders the description window at the bottom
func (v *PodcastListViewV2) drawDescriptionWindow(s tcell.Screen, startY, width, height int) {
...
func (v *PodcastListViewV2) wrapStyledText(text string, width int, highlightPositions []int, styles []markdown.StyleRange) []styledLineWithHighlights {
	if width <= 0 {
...
func (v *PodcastListViewV2) wrapParagraphWithStyles(paragraph string, width int, paragraphStartPos int, highlightMap map[int]bool, styles []markdown.StyleRange) []styledLineWithHighlights {
...
func (v *PodcastListViewV2) drawStyledLine(s tcell.Screen, x, y, maxWidth int, line styledLineWithHighlights) {
	highlightMap := make(map[int]bool)
